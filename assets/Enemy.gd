...
func take_damage(amount: int) -> void:
	...
	health -= amount
	print(">>> EXPLOSIVE LOVIT: ", name, " | HP: ", health, " | POS: ", global_position)
...
func setup_health_bar_style() -> void:
	...
	background_style.bg_color = Color(0.12, 0.12, 0.12)

	var fill_style := StyleBoxFlat.new()
	fill_style.bg_color = Color(0.65, 0.0, 1.0)
...
func explode_damage() -> void:
	...
	print("Explosion distance:", distance_to_player)

	if distance_to_player <= explosion_radius:
		if player.has_method("take_damage"):
			player.take_damage(explosion_damage)
			print("Explosion hit player for", explosion_damage, "damage")
...
func die() -> void:
	...
	print("!!! EXPLOSIVE DIED: ", name, " | POS: ", global_position)

	# SHAKE MULT MAI MARE SI PERSISTENT PENTRU EXPLOZIE
	ScreenShake.shake(22.0, 6.0)
	...
	_play_audio("res://sfx/EXPLOZIE.mp3", 12.0)
